  ...
  ({ placeholder, onPress, value }, ref) => {
    return (
      <Pressable
        ref={ref}
        onPress={onPress}
        className='absolute top-2 left-0 right-0 z-10 flex-row items-center bg-secondary rounded-[10px] overflow-hidden mx-4 my-2 h-[45px] border border-gray-200 shadow-2xl active:opacity-80'
      >
